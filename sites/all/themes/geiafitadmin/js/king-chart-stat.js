$(document).ready(function(){
	...
	if( $('.activity-pie-chart').length > 0 ) {
		...
		// cOptions.barColor = "#3E9C1A"; // green
// 		$('.activity-pie-chart.green').easyPieChart(cOptions);
// 		cOptions.barColor = "#FFB800"; // yellow
// 		$('.activity-pie-chart.yellow').easyPieChart(cOptions);
// 		cOptions.barColor = "#E60404"; // red
// 		$('.activity-pie-chart.red').easyPieChart(cOptions);
		
		
		///activity colors
		cOptions.barColor = "#00BFFF"; // light blue
		$('.activity-pie-chart.lightblue').easyPieChart(cOptions);
		cOptions.barColor = "#0000FF"; // blue
		$('.activity-pie-chart.blue').easyPieChart(cOptions);
		cOptions.barColor = "#00008B"; // dark
		$('.activity-pie-chart.darkblue').easyPieChart(cOptions);
		cOptions.barColor = "#ffff00"; // yellow
		$('.activity-pie-chart.yellow').easyPieChart(cOptions);
		cOptions.barColor = "#ff8000"; // orange
		$('.activity-pie-chart.orange').easyPieChart(cOptions);
	}

    if ($('.activity-log-chart').length > 0) {
        var cOptions = {
            animate: 3000,
            trackColor: "#ccc",
            scaleColor: "#ccc",
        ...
        cOptions.barColor = "#3E9C1A"; // green
        $('.activity-log-chart.green').easyPieChart(cOptions);
        cOptions.barColor = "#FFB800"; // yellow
        $('.activity-log-chart.yellow').easyPieChart(cOptions);
        cOptions.barColor = "#E60404"; // red
        $('.activity-log-chart.red').easyPieChart(cOptions);
    }
